...
frappe.ui.form.on("Journal Entry", {
		...
		if(frm.doc.docstatus==1) {
			frm.add_custom_button(__('Ledger'), function() {
				frappe.route_options = {
					...
					"to_date": frm.doc.reversing_date,
	...
	posting_date: function(frm) {
        ...
        reversing_date: function(frm) {
                if(!frm.doc.multi_currency || !frm.doc.reversing_date) return;
	...
	load_defaults: function() {
		...
		if(this.frm.doc.__islocal && this.frm.doc.company) {
			...
			if(!this.frm.doc.amended_from) this.frm.doc.posting_date = this.frm.posting_date || frappe.datetime.get_today();
                        if(!this.frm.doc.amended_from) this.frm.doc.reversing_date = this.frm.reversing_date || frappe.datetime.get_today();
...
frappe.ui.form.on("Journal Entry Account", {
	...
	account: function(frm, dt, dn) {
		...
		if(d.account) {
			...
			if(!frm.doc.reversing_date) frappe.throw(__("Please select Reversing Date first"));
			...
			return frappe.call({
				...
				args: {
					...
					reversing_date: frm.doc.reversing_date,
					company: frm.doc.company,
...
$.extend(erpnext.journal_entry, {
	...
	quick_entry: function(frm) {
			...
			fields: [
				...
				{fieldtype: "Date", fieldname: "posting_date", label: __("Date"), reqd: 1,
					default: frm.doc.posting_date},
                                {fieldtype: "Date", fieldname: "reversing_date", label: __("Date"), reqd: 1,
                                        default: frm.doc.reversing_date},
		...
		dialog.set_primary_action(__("Save"), function() {
			...
			frm.set_value("reversing_date", values.reversing_date);
