...
def reverse_gl_entries(gl_map, cancel=False, adv_adj=False, merge_entries=True, update_outstanding='Yes', from_repost=False):
	if gl_map:
		if not cancel:
...
def make_round_off_gle(gl_map, debit_credit_diff):
	...
	for k in ["voucher_type", "voucher_no", "company",
		"reversing__date", "remarks", "is_opening"]:
